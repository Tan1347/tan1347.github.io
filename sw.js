...
const BASE_CACHE_FILES = [
    ...
    'js/nioapp.min.js',
    'js/script.js',
    'https://s2.pstatp.com/cdn/expire-1-M/jquery/3.6.0/jquery.min.js',
    'https://s2.pstatp.com/cdn/expire-1-M/bootstrap/4.6.1/js/bootstrap.bundle.min.js',
    'https://s2.pstatp.com/cdn/expire-1-M/layer/3.5.1/layer.js',
    'https://s2.pstatp.com/cdn/expire-1-M/vue/2.6.14/vue.min.js',
    'https://s2.pstatp.com/cdn/expire-1-M/axios/0.26.0/axios.min.js',
    'favicon.ico'
];
// 离线缓存首页
